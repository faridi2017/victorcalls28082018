...
@Component({
  selector: 'app-duplicate-count',
  templateUrl: './duplicate-count.component.html',
  styleUrls: ['./duplicate-count.component.css']
})
export class DuplicateCountComponent implements OnInit {
...
blist; 
  ...
  // calling get api for raw leads
      this.loading=true;
      this.leadService.getUserLeads('15',sessionStorage.getItem('userName')).subscribe((data: MyLead[]) => {
