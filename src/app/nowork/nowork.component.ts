...
@Component({
  selector: 'app-nowork',
  templateUrl: './nowork.component.html',
  styleUrls: ['./nowork.component.css']
})
export class NoworkComponent implements OnInit {
blist;
  ...
  // calling get api for raw leads
      this.loading=true;
      this.rawLeadService.getUserLeads('2',sessionStorage.getItem('userName')).subscribe((data: MyLead[]) => {
