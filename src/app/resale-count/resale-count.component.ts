...
@Component({
  selector: 'app-resale-count',
  templateUrl: './resale-count.component.html',
  styleUrls: ['./resale-count.component.css']
})
export class ResaleCountComponent implements OnInit {
blist;
  ...
  this.loading=true;
      this.rawLeadService.getUserLeads('9',sessionStorage.getItem('userName')).subscribe((data: MyLead[]) => {
